...
<style>
  ...
  .auth-panel :global(.auth-submit:disabled) {
    opacity: 0.55;
    cursor: wait;
  }
  ...
  .auth-panel :global(.auth-message.error) {
    border-color: rgba(255, 123, 133, 0.36);
    color: #ffabb1;
  }

  .auth-panel :global(.auth-message.success) {
    border-color: rgba(99, 230, 151, 0.3);
    color: #8cebb0;
  }
